...
**作成日**: 2024-12-14 **対象Issue**: #9 Street Storyteller v1.0 ロードマップ
...
@target: `src/cli/modules/lsp/start.ts` @ref: `src/lsp/server/server.ts`,
`src/lsp/protocol/transport.ts`, `src/cli/base_command.ts`
...
@target: `src/application/view/file_watcher.ts` @ref:
`src/cli/modules/meta/watch.ts`
