...
| 4 | CLI段階移行 | 🟡 Wave-main done (Red-Green) / Refactor 残 | [→ plan/process-04.md](plan/process-04.md) |
| 5 | LSP/MCP adapter分離 | 🟡 Wave-main done (Red-Green) / Refactor 残 | [→ plan/process-05.md](plan/process-05.md) |
...
**Overall**: ✅ 3/10 completed (+ 3 partial)
