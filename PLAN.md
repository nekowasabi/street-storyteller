...
|---------|-------|--------|------|
| 1 | 契約固定とデータ形式決定 | ☐ planning | [→ plan/process-01.md](plan/process-01.md) |
| 2 | GoドメインとProject Loader基盤 | ☐ planning | [→ plan/process-02.md](plan/process-02.md) |
| 3 | Meta/Reference検出基盤 | ☐ planning | [→ plan/process-03.md](plan/process-03.md) |
| 4 | CLI段階移行 | ☐ planning | [→ plan/process-04.md](plan/process-04.md) |
| 5 | LSP/MCP adapter分離 | ☐ planning | [→ plan/process-05.md](plan/process-05.md) |
| 10 | 契約・回帰テスト整備 | ☐ planning | [→ plan/process-10.md](plan/process-10.md) |
| 11 | 遅いテストの隔離とtestkit整備 | ☐ planning | [→ plan/process-11.md](plan/process-11.md) |
