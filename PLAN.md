...
| 3 | Meta/Reference検出基盤 | 🟡 mostly done (frontmatter/position/reference + Cycle 2 SourceLocation 正規化済 / emitter+共通コア 未) | [→ plan/process-03.md](plan/process-03.md) |
...
**Overall**: ✅ 2/10 completed (+ 2 partial)
