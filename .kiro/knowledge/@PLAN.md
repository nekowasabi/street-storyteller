...
@target: src/cli/command_registry.ts @ref: @ARCHITECT.md
...
@target: . @ref: tests/command_registry_test.ts
...
@target: src/cli/types.ts @ref: src/cli/modules/index.ts
...
@target: src/cli/help/renderer.ts @ref: src/cli/types.ts
...
@target: src/cli/completions/generator.ts @ref: @ARCHITECT.md
...
@target: . @ref: tests/cli_generate_integration_test.ts
