...
JSON 出力に `confidence: number` と `entityId?: string`
が独立フィールドとして存在することを検証する TDD Red テスト。
...
- 期待値: JSON.parse(messages.info[0]) の diagnostics[0] に confidence: number /
  entityId: "hero"

## Red Phase

- [ ] 新規テスト追加 → Red 確認 ✅ Phase Complete

## Green Phase

- [ ] Process 3, 4 実装後に Green 確認 ✅ Phase Complete

## Refactor Phase

- [ ] テスト命名・期待値整形 ✅ Phase Complete
