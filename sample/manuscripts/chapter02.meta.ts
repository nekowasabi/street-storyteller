  ...
  validations: [
    {
      ...
      validate: (content: string) => {
        // 師匠が必ず登場していることを確認
        return content.includes("ガイウス") || content.includes("師匠") || content.includes("老剣士");
      },
    ...
    },
    {
      ...
      validate: (content: string) => {
        ...
        return content.includes("魔法の森") || content.includes("エンシェントフォレスト");
      },
    ...
    },
    {
      ...
      validate: (content: string) => {
        // 修行シーンが含まれていることを確認
        const hasTraining = content.includes("修行") || content.includes("教え") || content.includes("訓練");
        const hasMentor = content.includes("ガイウス") || content.includes("師匠");
