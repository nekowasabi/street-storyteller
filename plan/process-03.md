...
- [ ] LSP用の位置付き検出と meta 用の参照検出を共通コアへ寄せる ※未着手 (process-04 で対応)
- [ ] エラーコードとユーザー向けメッセージを整理 ※未着手 (process-04 で対応)
...
- **残 TODO**: emitter Golden test (Wave-A3-post)、共通コア寄せ (Refactor 残)、validation preset 読み込み口 (Cycle 3 候補)
